...
<Image src="/images/team-incidents-settings.png" alt="Incidents settings" width={800} height={400} />

## Smart incident merging

For more information on smart incident merging, see the [dedicated page](/incidents/smart-incident-merging).
