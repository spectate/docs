...
1. Go to the [Spectate Incident Channels](https://app.spectate.net/incidents/channels) and select "Webhook".
...
| `heartbeats.location`      | The location of the heartbeat.<br/>Possible values: `ams`, `mia`, `syd`, `nbg`,                |
