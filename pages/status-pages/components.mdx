...
This is required in order to make use of [automation](/status-pages/automation).
...
When you create an [incident](/status-pages/incidents), you can select which components are affected. This will automatically update the status of the component.
