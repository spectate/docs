...
You can configure a threshold for the number of user reports within a certain time period. If the threshold is reached, you will receive a notification on your [notification channels](/incidents/notification-channels).
...
You can configure the threshold for the number of user reports within a certain time period. If the threshold is reached, you will receive a notification on your [notification channels](/incidents/notification-channels).
